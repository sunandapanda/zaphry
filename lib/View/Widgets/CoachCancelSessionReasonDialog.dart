...
class CoachCancelSessionReasonDialog extends StatefulWidget {
  int index = 0;

  CoachCancelSessionReasonDialog(this.index);

  @override
  _CoachCancelSessionReasonDialogState createState() =>
      _CoachCancelSessionReasonDialogState();
}

class _CoachCancelSessionReasonDialogState extends State<CoachCancelSessionReasonDialog> {
        ...
        child: Row(
          ...
          children: [
            Column(
              children: [
                Text(
                  Controller.coachUpcomingSessions[widget.index].date,
                  style: TextStyle(
                      color: Colors.black,
                ...
                Text(
                  Controller.coachUpcomingSessions[widget.index].startTime,
                  style: TextStyle(
                      color: Colors.black,
                      fontSize: SizeConfig.height15,
                      fontWeight: FontWeight.bold),
            ...
            Column(
              ...
              children: [
                Text(
                  Controller.coachUpcomingSessions[widget.index].sessionType,
                ...
                Text(
                  Controller.coachUpcomingSessions[widget.index].status,
                  style: TextStyle(
                      color: Colors.black,
